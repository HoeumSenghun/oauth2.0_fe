  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        tabIndex={-1}
        className="relative z-10 w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-6 shadow-2xl outline-none dark:border-zinc-800 dark:bg-zinc-950 sm:p-8"
      >
        <button
          type="button"
          onClick={closeModal}
          aria-label="Close dialog"
          className="absolute right-4 top-4 rounded-lg p-2 text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-900"
        >
          ×
        </button>
        ...
        <h2
          id={titleId}
          className="pr-8 text-2xl font-semibold text-zinc-900 dark:text-zinc-50"
        >
        ...
        <div className="relative my-6">
          ...
          <p className="relative mx-auto w-fit bg-white px-3 text-xs uppercase tracking-wide text-zinc-400 dark:bg-zinc-950">
            or
          </p>
        </div>
